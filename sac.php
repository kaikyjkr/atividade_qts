...
<!-- Conteúdo do site -->
		...
		<div style="color: white; background-color: #007bff ;padding: 20px; margin-left: 110px; margin-right: 110px; border-style: solid;
			...
			<center>
				<h2>SAC - Fale conosco</h2>
			</center>
		</div>
		<div id="Pdestaques" style="top: 50px; position: relative;" >
			<div class="container shadow bg-white rounded pb-3">



				<div class="p-2 bd-highlight ">

                            <div class="pt-2 p-2 bd-highlight pl-5 text-center ">
                              <p>Sua mensagem será respondida em atá 48 horas.</p>
                              <p id="msg" class="text-danger h5"></p>

                            </div>
                            
                    <form id="formEnvioMensagem" method="POST" action="envioMensagemPHP.php">

                    <table>

                       <tr>
                            <td class="text-right"><label>Nome</label></td>
                            <td><input id="nome" class="border m-2 border-primary rounded p-2" type="text" name="nome" size="60" placeholder="" required></td>
                        </tr>              
                        <tr>
                            <td class="text-right"><label>Email</label></td>
                            <td><input id="email" class="border m-2 border-primary rounded p-2" type="email" name="email" size="60" placeholder=" " required></td>
                        </tr>
                        <tr>
                            <td class="text-right"><label>Celular</label></td>
                            <td><input id="telefone" onkeypress="mask(this, mphone);" onblur="mask(this, mphone);" class="border m-2 border-primary rounded p-2" type="text" name="telefone" size="20" maxlength="15" placeholder="Apenas números" required></td>
                        </tr>

                        <tr>
                            <td class="text-right"><label>Assunto</label></td>
                            <td><input id="estado" list="listaAssunto" class="border m-2 border-primary rounded p-2"  name="assunto" size="20" placeholder="Selecione" required>
                                <datalist id="listaAssunto">
                                    <option value="Financeiro">
                                    <option value="Suporte">
                                    <option value="Trocas e devoluções">
                                    <option value="Vendas">
                                    <option value="Outros">
                        ...
                        <tr>
							<td class="text-right" ><label>Mensagem</label></td>
							<td><textarea id="msgCliente" rows="5" cols="60" class="border m-2  border-primary rounded p-2" type="text" name="msgCliente" size="100" required></textarea></td>
						</tr>
                        ...
                        <tr>
                            <td colspan="2">
                                <center>
                                    <input id="btnEnviar" class="btn btn-primary"  type="submit" name="Enviar" value="Enviar">
