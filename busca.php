				 ...
				 <div class="container shadow-sm bg-white rounded ">
                     <div class="row align-items-start">
...

                        {
                            ...
                            $matriz = $conexao->prepare("SELECT * FROM produto  
                                                         WHERE NomeProduto 
                                                        LIKE '%$inpBusca%';");
                            ...
                            if($matriz->execute())
                            {
                                ...
                                {                                               
                                     ...
                                     echo '<img src="adm/IMG/'. $linha->imgProduto . '" class="card-img-top">';
                                     echo '<div class="card-body">';
                                     echo '<p class="card-text">' . $linha->NomeProduto . '</p>';
                                     echo '<h5 class="card-title">R$ '. $linha->ValorProduto .'</h5>';
                                     echo '<a type="button" class="btn btn-danger" href="http://localhost/id='.$linha->idProduto.'">Comprar</a>';
