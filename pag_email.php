...
<html lang="pt-br">
    ...
    <aside class="d-flex flex-column">
        ...
        <div class="container shadow bg-white rounded">    
            ...
            <h1 id="tituloRedefinir" class="text-center mb-2"><strong>Informe o seu e-mail</strong></h1>

            <h2 id="subtituloRedefinir" class="text-center mb-2">Insira um e-mail válido e redefina a sua senha. <br> Você receberá um link para estar atualizando a sua senha</h2>
                ...
                <div class="row justify-content-center">
                    ...
                    <form class="login-form" method="POST" action="">  
                        ...
                        <div class="text-left mb-2">
                            ...
                            <label id="label_email"><strong>E-mail</strong></label>

                            <tr>

                                <input id="input_email" class="border m-2 border-info rounded p-2" type="email" name="email" size="50" maxlength="50" required>
                        ...
                        <div class="text-left mb-2">
                            ...
                            <tr>
                                ...
                                <button id="btnEnviar" type="submit" class="btn btn-secondary">Enviar</button>

                                <td><a id="btnVoltar" href="login.php" class="btn btn-secondary">Voltar</a></td>
