...
<!-- Conteúdo do site -->
				...
				?>
    				...
    				<div class="p-2">
						...
						<nav class="navbar navbar-expand-lg navbar-light shadow-sm border border-info rounded bg-white ">
						  ...
						  <div class="collapse navbar-collapse" style="" id="conteudoNavbarSuportado">
		...
		<aside class="d-flex flex-column  ">
			...
			<div class="centro-site">
				
			<!-- Carrocel de Imagens -->
			<div id="carrossel" style="width: 1130px;">
    							...
    							<li data-target="#carouselExampleIndicators" data-slide-to="3" class="active"></li>
  								...
  								<div class="carousel-inner">
  									<?php
                       				 ...
                       				 $matriz = $conexao->prepare("SELECT * FROM slide ORDER BY idImagem DESC LIMIT 4 ");
                         			   ...
                         			   while($linha = $matriz->fetch(PDO::FETCH_OBJ))
                         				  {  
                         				    ...
                         				    echo' <div class="carousel-item '.$linha->estatus.'">
     		 								<img class="d-block w-100" src="adm/IMG/slide/'.$linha->linkImagem.'" width="600" height="300" alt="pcs">
     		 								<h5><center>'.$linha->nomeImagem.'</center></h5>
    										</div>';                                          
			...
			<div id="Pdestaques" style="top: 50px; position: relative;" >
				 ...
				 <div class="container shadow-sm bg-white rounded ">
                     <div class="row align-items-start">
                        ...
                        $matriz = $conexao->prepare("SELECT * FROM produto ORDER BY RAND() LIMIT 20");

                        if($matriz->execute())
                        {
                            while($linha = $matriz->fetch(PDO::FETCH_OBJ))
                            {                                               
                                 echo '<div class="card" style="width: 17rem; margin: 4px; border-color: #007bff;">';
                                 echo '<img src="adm/IMG/'. $linha->imgProduto . ' " class="card-img-top img-fluid p-1">';
                                 echo '<div class="card-body">';
                                 echo '<p class="card-text">' . $linha->NomeProduto . '</p>';
                                 echo '<h5 class="card-title">R$ '. $linha->ValorProduto .'</h5>';
                                 echo '<a type="button" name="" class="btn btn-danger" href="#">Comprar</a>';
                                 echo '<a type="button" class="btn btn-success ml-2" href="produto.php?id='.$linha->idProduto.'">Ver</a>';
                                 echo '</div>';
                                 echo '</div>';
                            }
                         }
			...
			<div class="container">
				<div class="row">
					...
					<div class="col-sm">
						...
						<a href="pol.php" class="metodos">Política de privacidade</a>
						<br>
