		...
		<aside class="d-flex flex-column  ">
			...
			<div class="d-flex flex-column bd-highlight">
                            ...
                            <div class="pt-2 bd-highlight pl-5  border-warning border-bottom">
                              <p class="text-uppercase h5">SUA CONTA</p>
                            </div>
                    ...
                    <div class="d-flex flex-row bd-highlight mb-3">
                          ...
                          <div class="p-2 p-5 bd-highlight">
                            ...
                            <div class="pt-2 h5 p-2 bd-highlight pl-5">
                              <p>Altere suas informações aqui</p>
                            </div>
                        ...
                        $matriz = $conexao->prepare("SELECT * FROM cliente WHERE idcliente = '$idcliente';");
                    ...
                    <form id="formCadastroCliente" class="ml-5" method="POST" action="atualizarClientePHP.php">

                    <table>

                        <tr>
                            <td class="text-right"><label>CPF</label></td>
                            <td><input id="cpf" onkeydown="javascript: fMasc( this, mCPF );" class="border m-2 border-info rounded p-2" type="text" name="cpf" size="20" maxlength="14" onkeypress="return event.charCode >= 48" placeholder=" Apenas números" required value="<?php echo $linha->cpf;?> ">
                            </td>
                        </tr>

                        <tr>
                            <td class="text-right"><label>Nome</label></td>
                            <td><input id="nome" class="border m-2 border-info rounded p-2" type="text" name="nome" size="20" placeholder="" required value="<?php echo $linha->nomecliente;?>"></td>
                        </tr>

                        <tr>
                            <td class="text-right"><label>Sobrenome</label></td>
                            <td><input id="sobrenome" class="border m-2 border-info rounded p-2" type="text" name="sobrenome" size="40" placeholder="" required value="<?php echo $linha->sobrenome;?>"></td>
                        </tr>
                        
                        <tr>
                            <td class="text-right"><label>Email</label></td>
                            <td><input id="email" class="border m-2 border-info rounded p-2" type="email" name="email" size="40" placeholder=" " required value="<?php echo $linha->email;?>"></td>
                        </tr>
                        <tr>
                            <td class="text-right"><label>Senha</label></td>
                            <td><input id="senha" minlength="8" class="border m-2 border-info rounded p-2" type="password" name="senha" value="<?php echo $linha->senha;?>" placeholder="" required>(min. 8 caracteres). </td>
                        </tr>
                        <tr>  
                            <td class="text-right"><label>Senha digitada</label></td>  
                            <td><div id="exibir" class="m-2 p-2" value="<?php echo $linha->senha;?>"></div></td>
                        </tr>

                        <tr>
                            <td class="text-right"><label>Nascimento</label></td>
                            <td><input id="data" class="border m-2 border-info rounded p-2" type="date" name="data" placeholder="" required value="<?php echo $linha->nasc;?>"></td>
                        </tr>


                        <tr>
                            <td class="text-right"><label>Logadouro</label></td>
                            <td><input id="endereco" class="border m-2 border-info rounded p-2" type="text" name="endereco" size="40" placeholder="Rua / Av / Alamenda..." required value="<?php echo $linha->logadouro;?>"></td>
                        </tr>

                        <tr>
                            <td class="text-right"><label>Nº</label></td>
                            <td><input id="numero" maxlength="4" class="border m-2 border-info rounded p-2" type="text" name="numero" size="10"  required value="<?php echo $linha->numero;?>"></td>
                        </tr>
                        <tr>
                            <td class="text-right"><label>Complemento</label></td>
                            <td><input id="complemento" class="border m-2 border-info rounded p-2" type="text" name="complemento" size="20" placeholder="AP 05 Bloco 3 " required value="<?php echo $linha->complemento;?>"></td>
                        </tr>

                        <tr>
                            <td class="text-right"><label>CEP</label></td>
                            <td><input id="cep" onkeydown="javascript: fMasc( this, mCEP );" class="border m-2 border-info rounded p-2" type="text" name="cep" size="20" maxlength="10" required value="<?php echo $linha->cep;?>"></td>
                        </tr>

                        <tr>
                            <td class="text-right"><label>Bairro</label></td>
                            <td><input id="bairro" class="border m-2 border-info rounded p-2" type="text" name="bairro" size="20" placeholder=" " required value="<?php echo $linha->bairro;?>"></td>
                        </tr>

                        <tr>
                            <td class="text-right"><label>Cidade</label></td>
                            <td><input id="cidade" class="border m-2 border-info rounded p-2" type="text" name="cidade" size="20" placeholder="" required value="<?php echo $linha->cidade;?>"></td>
                        </tr>

                        <tr>
                            <td class="text-right"><label>Estado</label></td>
                            <td><input id="estado" list="listaEstado" maxlength="2" class="border m-2 border-info rounded p-2"  name="estado" size="2" placeholder="SP" required value="<?php echo $linha->estado;?>">
                        ...
                        <tr>
                            ...
                            <td><input id="telefone" onkeypress="mask(this, mphone);" onblur="mask(this, mphone);" value="<?php echo $linha->telefone;?>" class="border m-2 border-info rounded p-2" type="text" name="telefone" size="20" maxlength="15" placeholder="Apenas números" required></td>
                        </tr>

                        <tr>
                            <td class="text-right"><label>Informacoes adicionais</label></td>
                            <td><input id="infoAdicionais" class="border m-2 border-info rounded p-2" type="text" name="infoAdicionais" size="40" placeholder=" " required value="<?php echo $linha->adccliente;?>"></td>
                        </tr>
