  			...
  			<div id="Pdestaques" style="top: 50px; position: relative;">
  				...
  				<div class="container shadow-sm bg-white rounded pl-5 pt-5">
  					...
  					<div class="d-flex flex-column bd-highlight pl-5 ml-5 w-75">
  						...
  						$Matriz=$conexao->prepare("SELECT CodProduto,NomeProduto,ValorProduto,imgProduto FROM produto");
  						if ($Matriz->rowCount() == 0) {
  							echo'
  							<h1>Sua compra foi finalizada</h1>
  							<br>
  							<h2>Obrigado por Comprar na Doutor PC</h2>
  							';
  					 //////////////////////deletar itens após a compra
